...
<div class="wrapper col1">
  <div id="header">
    <div class="fl_left">
        <center><h1><a href="#">Securely Distributing Files in Cloud Environment by Dispensing Asymmetric Key Management System Applying Hashing</a></h1></center>
  ...
  <div id="topbar">
    <div id="topnav">
      <ul>
        ...
        <li class="last"><a href="talog.jsp">CERTIFICATE AUTHORITY</a></li>
...
<center><h2 style="color: #e60498">CERTIFICATE AUTHORITY LOGIN</h2></center>
<!-- ####################################################################################################### -->
